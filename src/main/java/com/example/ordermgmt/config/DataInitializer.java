...
public class DataInitializer {
    ...
    // Inventory (no hardcoded ID — UUID v7 is auto-generated by @UuidGenerator)
    ...
    private AppUser initCustomerUser(AppUserRepository userRepository, UserRole role,
            PasswordEncoder passwordEncoder) {
        ...
        return userRepository.findByEmail(EMAIL_CUSTOMER)
                ...
                .orElseGet(() -> {
                    ...
                    // userId is auto-generated by @UuidGenerator (UUID v7)
    ...
    private void initCustomerProfile(CustomerRepository customerRepository, AppUser user) {
        ...
        if (customerRepository.findByAppUser(user).isEmpty()) {
            ...
            // customerId is auto-generated by @UuidGenerator (UUID v7)
    ...
    private void initInventory(InventoryItemRepository inventoryRepository) {
        ...
        // Check by name since we no longer have a hardcoded String ID
        boolean laptopExists = inventoryRepository.findAll().stream()
                .anyMatch(i -> ITEM_LAPTOP_NAME.equalsIgnoreCase(i.getItemName()));
        if (!laptopExists) {
            InventoryItem item1 = new InventoryItem();
            // itemId is auto-generated by @UuidGenerator (UUID v7)
            ...
            logger.info("  [+] Created Inventory Item: {}", ITEM_LAPTOP_NAME);
        } else {
            logger.info("  [-] Inventory Item exists: {}", ITEM_LAPTOP_NAME);
        }
    }
}
